...
/*************************** 硬件抽象层配置 ****************************/
// GPIO地址切换宏定义
#define Switch_Address_0(i) ((i)?(DL_GPIO_setPins(GPIO_FOLLOW_LINE_PORT, GPIO_FOLLOW_LINE_PIN_GPIO_FOLLOW_LINE_0_PIN)) : (DL_GPIO_clearPins(GPIO_FOLLOW_LINE_PORT, GPIO_FOLLOW_LINE_PIN_GPIO_FOLLOW_LINE_0_PIN)))// 地址位0控制

#define Switch_Address_1(i) ((i)?(DL_GPIO_setPins(GPIO_FOLLOW_LINE_PORT, GPIO_FOLLOW_LINE_PIN_GPIO_FOLLOW_LINE_1_PIN)) : (DL_GPIO_clearPins(GPIO_FOLLOW_LINE_PORT, GPIO_FOLLOW_LINE_PIN_GPIO_FOLLOW_LINE_1_PIN)))// 地址位1控制

#define Switch_Address_2(i) ((i)?(DL_GPIO_setPins(GPIO_FOLLOW_LINE_PORT, GPIO_FOLLOW_LINE_PIN_GPIO_FOLLOW_LINE_2_PIN)) : (DL_GPIO_clearPins(GPIO_FOLLOW_LINE_PORT, GPIO_FOLLOW_LINE_PIN_GPIO_FOLLOW_LINE_2_PIN)))// 地址位2控制
